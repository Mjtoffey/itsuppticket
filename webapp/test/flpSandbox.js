		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#itsuppticket-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itsuppticket-display": {
								"semanticObject": "itsuppticket",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=itsuppticket",
									"url": sap.ui.require.toUrl("itsuppticket")
								}
							}
						}
					}
